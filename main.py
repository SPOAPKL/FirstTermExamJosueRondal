...
db_users = [
    User(id=1, username="admin", password="dog123", email="admin@mail.com"),
    User(id=2, username="user", password="tiger456", email="user@mail.com"),
    User(id=3, username="guest", password="panther789", email="guest@mail.com"),
]
